...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createUser.js":[function(require,module,exports) {
"use strict";
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _createUser.registerUser)(fname, lname, role, email, password, passwordConfirm);
  });
}
...
if (manageEquipe) {
  ...
  var _loop = function _loop(_i) {
    askDelete[_i].addEventListener('click', function (e) {
      e.preventDefault();
      var confirmDelete = document.querySelectorAll('.confirmDelete')[_i];
  ...
  for (var _i = 0; _i < askDelete.length; _i++) {
    _loop(_i);
  }
  ...
  var equipeID = "";
  for (var _i2 = 0; _i2 < deleteEquipeList.length; _i2++) {
    deleteEquipeList[_i2].addEventListener('click', function (e) {
      e.preventDefault();
