    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          info = document.querySelector('#logo section');
        ...
        case 6:
          ...
          if (res.data.status === 'success') {
            ...
            info.innerHTML = "<p style=\"margin:0 \">Bienvenue ".concat(res.data.data.user.firstName, "</p>");
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
        ...
        case 10:
          ...
          info.innerHTML = "<p style=\"margin:0 \">".concat(_context.t0.response.data.message, "</p>");
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"match.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          return _context.abrupt("return", res.data.data.matchs);
        case 10:
          _context.next = 15;
          break;
        case 12:
...
function searchMatchByTeam(queryResult, enteredValue) {
  ...
  queryResult.forEach(function (matchInfo, index, matchInfoFull) {
    if (matchInfo.againstTeam.toUpperCase().includes(enteredValue.toUpperCase()) || matchInfo.localTeam.toUpperCase().includes(enteredValue.toUpperCase())) {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"user.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateUser = exports.registerUser = exports.deleteUser = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var registerUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(fname, lname, role, email, password, passwordConfirm) {
    var res, fname2, lname2, role2, email2, password2, passwordConfirm2;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            fname2 = document.querySelector('.fname');
            lname2 = document.querySelector('.lname');
            role2 = document.querySelector('input[name="role"]:checked');
            email2 = document.querySelector('.email');
            password2 = document.querySelector('.password');
            passwordConfirm2 = document.querySelector('.passwordConfirm');
            fname2.value = '';
            lname2.value = '';
            email2.value = '';
            password2.value = '';
            passwordConfirm2.value = '';
            (0, _alert.showAlert)('success', 'Inscription réussie !');
            // window.setTimeout(() => {
...
var updateUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(result, id, team) {
    var data, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 4:
          ...
          if (res.data.status === "success") {
            ...
            (0, _alert.showAlert)("success", "Utilisateur modifié avec succès");
            window.setTimeout(function () {
              var modal = document.querySelector('.modal');
              var modalContent = document.querySelector('.modal-content');
              var infoUser = res.data.data.updateUser;
...
var deleteUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id, elToRemove) {
    var res;
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          if (res.data === "") {
            ...
            (0, _alert.showAlert)("success", "Utilisateur supprimé avec succès");
          }
          _context3.next = 11;
          break;
        case 8:
          ...
          (0, _alert.showAlert)("error", _context3.t0.response.data);
        case 11:
        case "end":
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"equipe.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateEquipe = exports.deleteEquipe = exports.createEquipe = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var createEquipe = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(wording, trainer, slot, comment) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Équipe créée avec succès");
            window.setTimeout(function () {
              var modal = document.querySelector('.modal');
              var modalContent = document.querySelector('.modal-content');
              modal.classList.add('hidden');
  ...
  return function createEquipe(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var manageUser = document.querySelector('.adminUserUD');
var createEquipeForm = document.querySelector('.adminEquipeC');
var updateEquipeForm = document.querySelectorAll('.adminEquipeUD .updateEquipe');
var updateUserForm = document.querySelectorAll('.adminUserUD .updateUser');
var registerForm = document.querySelector('.formCreateUser');
if (searchFormMatch) {
  (0, _match.init)();
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _user.registerUser)(fname, lname, role, email, password, passwordConfirm);
  });
}
...
if (manageUser) {
  var deleteUserList = document.querySelectorAll('.deleteUser');
  var askDelete = document.querySelectorAll('.askDeleteUser');
  var _loop = function _loop(i) {
    askDelete[i].addEventListener('click', function (e) {
      e.preventDefault();
      var confirmDelete = document.querySelectorAll('.confirmDelete')[i];
  ...
  var userID = "";
  for (var _i = 0; _i < deleteUserList.length; _i++) {
    deleteUserList[_i].addEventListener('click', function (e) {
      e.preventDefault();
              ...
              case 3:
                ...
                if (res.data.status === 'success') {
                  ...
                  validateForm.addEventListener('click', function (e) {
                    ...
                    (0, _user.updateUser)(dataUser, id, team);
                    modal.classList.add('hidden');
                    modalContent.classList.add('hidden');
...
var menuLinks = document.querySelectorAll('nav>section>a');
for (var _i2 = 0; _i2 < menuLinks.length; _i2++) {
  menuLinks[_i2].addEventListener('click', closeMenu);
}
function closeMenu() {
...
if (manageEquipe) {
  ...
  var _askDelete = document.querySelectorAll('.askDeleteEquipe');
  var _loop2 = function _loop2(_i3) {
    _askDelete[_i3].addEventListener('click', function (e) {
      e.preventDefault();
      var confirmDelete = document.querySelectorAll('.confirmDelete')[_i3];
      var parentHeight = e.target.parentElement.parentElement.parentElement.parentElement.clientHeight;
      confirmDelete.style.display = "flex";
      confirmDelete.style.height = "".concat(parentHeight, "px");
    });
  };
  for (var _i3 = 0; _i3 < _askDelete.length; _i3++) {
    _loop2(_i3);
  }
  var _deleteNo = document.querySelectorAll('.deleteNo');
  _deleteNo.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      document.querySelectorAll('.confirmDelete').forEach(function (item) {
        item.style.display = "none";
  ...
  var equipeID = "";
  for (var _i4 = 0; _i4 < deleteEquipeList.length; _i4++) {
    deleteEquipeList[_i4].addEventListener('click', function (e) {
      e.preventDefault();
...
if (createEquipeForm) {
  ...
  var _modalContent = document.querySelector('.createEquipe');
  var _modalFooter = document.querySelector('.createEquipe .modal-footer');
  var _validateForm = document.querySelector('.createEquipe .btn-success');
  createEquipeForm.addEventListener('click', function (e) {
  ...
  _modalFooter.addEventListener('click', function (e) {
    _modal.classList.add('hidden');
    _modalContent.classList.add('hidden');
  });
  _validateForm.addEventListener('click', function (e) {
    e.preventDefault();
    var wording = document.querySelector('.createEquipe #wording').value;
    var trainer = document.querySelector('.createEquipe #trainer').value;
    var slot = document.querySelector('.createEquipe #slot').value;
    var comment = document.querySelector('.createEquipe #comment').value;
    (0, _equipe.createEquipe)(wording, trainer, slot, comment);
    _modal.classList.add('hidden');
    _modalContent.classList.add('hidden');
  });
}
if (updateEquipeForm) {
  ...
  var _modalContent2 = document.querySelector('.updateEquipeForm');
  var _modalFooter2 = document.querySelector('.updateEquipeForm .modal-footer');
  var _validateForm2 = document.querySelector('.updateEquipeForm .btn-success');
  updateEquipeForm.forEach(function (el) {
    el.addEventListener('click', function (e) {
      ...
      _modal2.classList.remove('hidden');
      _modalContent2.classList.remove('hidden');
      _modal2.addEventListener('click', function (e) {
        _modal2.classList.add('hidden');
        _modalContent2.classList.add('hidden');
      });
      _modalFooter2.addEventListener('click', function (e) {
        _modal2.classList.add('hidden');
        _modalContent2.classList.add('hidden');
      });
      _validateForm2.addEventListener('click', function (e) {
        e.preventDefault();
        var form = new FormData();
